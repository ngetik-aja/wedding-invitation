...
export function MusicForm() {
  ...
  const selectedMusic = useWatch({ control, name: "music.selectedMusic" });
  ...
  useEffect(() => {
    if (selectedMusic === "custom" && audioRef.current) {
      audioRef.current.pause();
      audioRef.current.currentTime = 0;
      setPlayingId(null);
    }
                    ...
                    <div key={music.id}>
                      ...
                      >
                        ...
                        {music.src && (
                          <button
                            type="button"
                            aria-label={`Pratinjau ${music.name}`}
                            className={cn(
